...
public class editGRNController implements Initializable {
    DB db =new DB();
    @FXML
    ...
    public void setDet(String pid,String grnNo,String sup,String qty,String amount,String uid){
        txtGRNNo.setText(grnNo);
        txtProId.setText(pid);
        txtSup.setText(sup);
        txtQty.setText(qty);
